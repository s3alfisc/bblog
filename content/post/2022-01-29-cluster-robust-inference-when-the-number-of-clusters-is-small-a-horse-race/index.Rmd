...
Both for $G = 50$ and $G = 100$, the wild cluster bootstrap and Satterthwaite corrected errors perform equally well and achieve close to 95% coverage for all intra-cluster correlations $\rho$. The unadjusted CRVE estimates instead only achieve coverage rates of around 93 and 94%.
